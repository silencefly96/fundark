...
class RetryAndFollowUpInterceptor(
    ...
    var streamAllocation1: StreamAllocation1? = null
...
//        // 为了学习，假装下这里创建了
//        var streamAllocation =
//            StreamAllocation1()
//        this.streamAllocation1 = streamAllocation
//
...
//        }
    ...
    fun recover(e: IOException, streamAllocation1: StreamAllocation1, requestSendStarted: Boolean,
                userRequest: Request): Boolean {
        // streamAllocation1.streamFailed(e)
