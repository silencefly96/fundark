 ...
 */
public final class Http1Codec1 implements HttpCodec {
    ...
    public Http1Codec1(OkHttpClient client, StreamAllocation streamAllocation, BufferedSource source,
                       BufferedSink sink) {
        this.client = client;
    ...
    @Override public ResponseBody openResponseBody(Response response) throws IOException {
        ...
        // 响应包含响应头和响应体，这里的响应体是对原始httpCodec的source装饰
        if (!HttpHeaders.hasBody(response)) {

            // !!注意AbstractSource是内部类，持有httpCodec的source，并从中读取ResponseBody
            // 实际就是对httpCodec的source(socket流)的装饰模式
    ...
    private abstract class AbstractSource implements Source {
        ...
        protected final void endOfInput(boolean reuseConnection, IOException e) throws IOException {
            ...
            if (streamAllocation != null) {
                streamAllocation.streamFinished(!reuseConnection, Http1Codec1.this, bytesRead, e);
            }
        }
    }
